...
class Card {
    ...
    public static Card getCardByName(String name) {
        ...
        switch (name) {
            case "Тарна":
                return new Card(0, name, "", 1, 0, 0, 0, "ТАП:4 Взять карт 1.", 0, 28);
            case "Рейвенкар":
            ...
            case "Тиша":
                return new Card(0, name, "", 3, 0, 0, 1, "ТАПТ:2 Отравить+ выбранное существо на 1.", 0, 26);
            case "Тейа":
                return new Card(0, name, "", 1, 0, 3, 3, "ТАПТ:2 Ранить персонажа на 1. 2ТАПТ:5 Ранить персонажа на 2.", 0, 26);
            case "Алирра":
            ...
            case "Нархи":
                return new Card(0, name, "Герой-маг", 4, 0, 0, 0, "ТАП: Получите до конца хода * 2.", 0, 26);
            case "Свирепый резак":
            ...
            case "Поглощение души":
                return new Card(3, name, "", 5, 1, 2, 0, "Ранить выбранного героя на 3. Излечить вашего героя на 3.", 0, 0);
            case "Эльф-дозорный":
                return new Card(4, name, "", 4, 2, 0, 0, "Найм: Возьмите карт 1.", 2, 5);
            case "Послушник":
            ...
            case "Гном-каратель":
                return new Card(4, name, "Гном", 3, 2, 0, 3, "Броня 2. ТАПТ: Ранить персонажа на 2.", 1, 3);
            case "Тан гномов":
            ...
            case "Орк-арбалетчик":
                return new Card(5, name, "Орк", 2, 2, 3, 0, "Наймт: Выстрел на 1. Цель не обязательно, без повторов.", 5, 3);
            default:
