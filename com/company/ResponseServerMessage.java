...
public class ResponseServerMessage extends Thread {
    ...
    public synchronized void run() {
        ...
        if (fromServer.contains("#TotalStatusPlayer")) {//All player connected
            ...
            ArrayList<String> parameter = MyFunction.getTextBetween(fromServer);
            if (players[0].playerName.equals(parameter.get(0))){
                Board.creature.get(0).add(new Creature(Card.getCardByName(parameter.get(1)),players[0]));
            }
            else {
                Board.creature.get(1).add(new Creature(Card.getCardByName(parameter.get(1)),players[1]));
            }
            ...
            if (players[0].playerName.equals(parameter.get(0))){
                ...
                Main.printToView(0,parameter.get(4));
            }
