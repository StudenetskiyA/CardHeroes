...
public class Main extends JFrame{
    ...
    public static String userName="Jeremy";
    ...
    static  int heroW = (int)(main.getWidth()*CARD_SIZE_FROM_SCREEN);
    static  int heroH = (heroW*400/283);
    static  int smallCardW = (int)(heroW*0.7);
    static  int smallCardH = (int)(heroH*0.7);
    static  int cardX =B0RDER_LEFT+B0RDER_BETWEEN*3+smallCardW*3;
    ...
    private static class MyListener extends MouseInputAdapter {
        ...
        public void mouseReleased(MouseEvent e) {
            if ((whereMyMouse==Compo.Board.toString()) && (cardMem.type==2)) {
                //  put on board
                    ...
                    System.out.println("$PLAYCARD("+num+","+"0,0)");
            }
               ...
               creatureMem.attackPlayer(enemy);
                ...
                System.out.println("$PLAYCARD("+num+",0,1)");
            }
                ...
                System.out.println("$PLAYCARD("+num+","+whereMyMouseNum+",0)");
        ...
        public void mouseDragged(MouseEvent e) {
            if (onWhat==Compo.CardInHand){//Creature in hand
                ...
                if (board.creature.get(0).get(num).isTapped){printToView("Повернутое существо не может атаковать.");}
                else {
                    if (board.creature.get(0).get(num).isSummonedJust){printToView("Это существо вошло в игру на этом ходу.");}
                    else {
